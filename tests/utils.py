...
def baseline_blocks():
    bb = [['#                                                                             #'],
          ...
          ['class-map match-any DEFAULT', '  match access-group name DEFAULT-CLASSIFY'],
          ...
          ['ip access-list extended CONTROL-CLASSIFY',
           ...
           ' deny   ip any any'],
          ['ip access-list extended DEFAULT-CLASSIFY', ' permit ip any any'],
          ...
          ['ip access-list extended TRANSACTIONAL-CLASSIFY',
           ' remark AF21 CAPWAP, Cisco ISE Traffic & Other Control & Important Data '
           'Such as Citrix.',
...
def baseline_partition():
    bp = Partition(ignored=[' server name xxxxxx12345',
                    ...
                    ['crypto pki certificate chain TP-self-signed-1234567890',
                ' certificate self-signed 01',
                '  1D16574F 1D16574F 1D16574F 1D16574F 1D16574F 1D16574F '
                '1D16574F 1D16574F',
                '  1D16574F 1D16574F 1D16574F 1D16574F 1D16574F 1D16574F '
                '1D16574F 1D16574F',
                '  1D16574F 1D16574F 1D16574F 1D16574F',
    ...
    recorded=[['#                                                                             '
                ...
                ['#                                   '
                'WARNING!!!                                #'],
                ['#                   THIS DEVICE IS PART OF A PRIVATE '
                'NETWORK                  #'],
                ['###############################################################################'],
                ['###############################################################################'],
                ['###############################################################################'],
                ['#This system is solely for the use of authorised users for '
                'official purposes. #'],
                ...
                'of such          #'],
                ['#is functioning properly, individuals using this computer '
                'system are subject  #'],
                ...
                ['*                                                                    '
                '*'],
                ['* Evidence of unauthorised use collected during monitoring may '
                'be    *'],
                ['* If you are not authorised to access this system, terminate '
                'this    *'],
                ['* Under the Computer Misuse Act, it is a criminal offence '
                'to         *'],
                ['* WARNING. This is a private computer system, unauthorised '
                'access to *'],
                ['* and '
                'recorded.                                                      '
                '*'],
                ['* knowingly access or try to access unauthorised material on '
                'this    *'],
                ['* session '
                'now.                                                       *'],
                ['* system constitutes consent to monitoring for these '
                'purposes.       *'],
                ['* system, or to abuse this system and its '
                'data.                      *'],
                ['* this system is prohibited.  All usage of this system is '
                'monitored  *'],
                ['* used for administrative, criminal, or other action. Use of '
                'this    *'],
                ['**********************************************************************'],
                ['**********************************************************************'],
                ['^C'],
                ...
                ' deny   ip any any'],
                ['ip access-list extended TRANSACTIONAL-CLASSIFY',
                ' remark AF21 CAPWAP, Cisco ISE Traffic & Other Control & '
                'Important Data Such as Citrix.',
                ' permit udp any any eq 1645',
                ' permit udp any any eq 1646',
                ' permit udp any any eq 1812',
                ' permit udp any any eq 1813',
                ...
                ['mls qos srr-queue input dscp-map queue 1 threshold 2 24'],
                ['mls qos srr-queue input dscp-map queue 1 threshold 3 48 56'],
                ['mls qos srr-queue input dscp-map queue 2 threshold 3 32 36 38 '
                '40 46'],
                ['mls qos srr-queue input priority-queue 2 bandwidth 30'],
                ['mls qos srr-queue input threshold 1 80 90'],
                ['mls qos srr-queue output dscp-map queue 1 threshold 3 40 46'],
                ['mls qos srr-queue output dscp-map queue 2 threshold 1 16 18 20 '
                '22 26 28 30 34'],
                ['mls qos srr-queue output dscp-map queue 2 threshold 1 36 38'],
                ['mls qos srr-queue output dscp-map queue 2 threshold 2 24'],
                ['mls qos srr-queue output dscp-map queue 2 threshold 3 48 56'],
                ['mls qos srr-queue output dscp-map queue 3 threshold 3 0'],
                ['mls qos srr-queue output dscp-map queue 4 threshold 1 8'],
                ['mls qos srr-queue output dscp-map queue 4 threshold 2 10 12 '
                '14'],
                ['no aaa accounting system guarantee-first'],
                ['no ip domain-lookup'],
                ['no service pad'],
                ...
                'no-auth-fail-vlan no-guest-vlan'],
                ['snmp-server enable traps energywise'],
                ['snmp-server enable traps entity'],
